...
import { importCampaigns } from "@/api/campaigns";
...
type ImportCampaignDialogProps = {
  onImported?: () => void;
};

export function ImportCampaignDialog({ onImported }: ImportCampaignDialogProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      const res = await importCampaigns(file);
      setStatus("success");
      setMessage(res?.message ?? "Campaigns imported successfully.");
      onImported?.();
    } catch (error) {
      setStatus("error");
      setMessage(
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent showCloseButton={!isLoading}>
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file to bulk import campaigns.
          </DialogDescription>
        </DialogHeader>
